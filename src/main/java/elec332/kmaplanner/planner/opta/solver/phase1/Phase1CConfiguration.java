 ...
 */
public class Phase1CConfiguration implements IPhaseConfiguration<LocalSearchPhaseConfig> {
    ...
    public LocalSearchPhaseConfig createPhase(PlannerSettings settings) {
        ...
        moveListFactoryConfig.setMoveListFactoryClass(WideConflictChangeMoveFactory.class);
